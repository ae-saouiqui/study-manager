    ...
    <main class="container-fluid col-12">
        <section class="header-section container-fluid col-12 mt-3">
            ...
            <div class="services d-flex mt-4 justify-content-evenly">
                <div class="service-1 shadow"><a href="gestionProfesseur.php">Professeur<i class="fa-solid fa-chalkboard-user"></i></a>
                </div>
                <div class="service-2 shadow"><a href="/index.php?action=getAllRooms">Room<i class="fa-solid fa-comments"></i></a></div>
                <div class="service-3 shadow"><a href="/index.php?action=getAllFiliere">Filiere<i class="fa-solid fa-user-group"></i></a></div>
                <div class="service-4 shadow"><a href="/index.php?action=getAllAnnonce">Annonce<i class="fa-solid fa-newspaper"></i></a></div>
            </div>
        </section>
                            ...
                            data: {
                                ...
                                datasets: [{
                                    ...
                                    backgroundColor: (context) => {
                                        ...
                                        gradient.addColorStop(0, "#d2601a");
